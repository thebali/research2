...
The scope of the dataset intended to be used in this project consists complete database for Digital Music category from the Amazon.com - the ecommerce website system from the 

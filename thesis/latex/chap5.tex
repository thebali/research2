...
Use of RMSE value is justified by the previous findings in the study by Koren, 2008[\cite{}] that small improvements in RMSE terms can have significant impact on the quality of some of the top recommendations.

...
2. Choose {\displaystyle $\varphi _{k}$\sim \operatorname {Dir} ($\beta$ )} {\displaystyle \varphi _{k}\sim \operatorname {Dir} (\beta )}, where $k\in \{1,\dots ,K\}$ and $\beta$  typically is sparse

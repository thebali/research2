...
\begin{figure}[H]
    {\centering {\includegraphics[width = 0.7 \textwidth]{img/DissimEqn.png}}\par}
...
\begin{figure}[H]
    {\centering {\includegraphics[width = 0.7 \textwidth]{img/PearsonEqn.png}}\par}
    \caption{579483}
\end{figure}
...
\begin{figure}[H]
    {\centering {\includegraphics[width = 0.7 \textwidth]{img/PredUserEqn.png}}\par}
    \caption{464875}
\end{figure}
...
\begin{figure}[H]
    {\centering {\includegraphics[width = 0.7 \textwidth]{img/ItemSimEqn.png}}\par}
    \caption{457900}
\end{figure}


\begin{figure}[H]
    {\centering {\includegraphics[width = 0.7 \textwidth]{img/PredItemEqn.png}}\par}
    \caption{679849}
\end{figure}

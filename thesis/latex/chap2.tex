...
\bullet{\textit{Collaborative Filtering}: Observing the watching and browsing habits of similar users.}

• \textit{Content-Based Filtering}: Observing users with equal preferences and how they rated certain movies.

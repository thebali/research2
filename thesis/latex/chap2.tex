...
\subsection{Selecting a (Learning) model}
A key component when implementing a recommender system using content-based filter ing is choosing a method for how the algorithm should be trained [16, 17], using available
data from the system. Using this data to create a model of a user’s preferences and his-
tory in the system can be seen as a kind of classification problem. There are several

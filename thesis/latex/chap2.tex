...
A key component when implementing a recommender system using content-based filter-
ing is choosing a method for how the algorithm should be trained [16, 17], using available

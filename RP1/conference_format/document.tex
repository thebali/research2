...
Receiver operating characteristic (ROC) curve is the graph of true positive rate versus false positive rate. Area Under ROC curve (AUC), A is defined as the following integral:

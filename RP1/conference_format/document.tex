...
Denote by x
+an instance that contains the event and denote by
x
−
an instance that does not contain the event. Then true positive means that f False positive means that. 
Receiver operating characteristic (ROC) curve is the graph of true positive rate versus false positive rate. The area under this curve (AUC),A, is defined as the following integral:

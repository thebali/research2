...
Receiver operating characteristic (ROC) curve is the graph of true positive rate versus false positive rate. The area under curve (AUC),A, is defined as the following integral:

\begin{equation}includegraphics[width=0.5 \textwidth]{images/AUC}
    \label{eq:AUC} \tag
\end{equation}

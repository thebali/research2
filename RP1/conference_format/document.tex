...
\begin{figure*}[b]
\begin{equation}
UserSim(x, y) = \frac{\sum_{i \in I} ({R_{x,i} - \overline{R}_x}) ({R_{y,i} - \overline{R}_y})} {\sqrt{\sum_{i \in I}({R_{x,i} - \overline{R}_x})^2} \sqrt{\sum_{u \in I}({R_{y,i} - \overline{R}_y})^2}}

...
For the purposes of evaluating our model we used Root Mean Squared Er​ror (RMSE). In the datasets, we selected a random set for training which is 80\% of the total dataset, 

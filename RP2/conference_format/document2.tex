...
\begin{abstract}
	...
	The suggested model is applied on the review text to model user preferences and item features. Topic Modeling has been employed in this model on the review text, this allows matching topics with rating dimensions to optimize prediction accuracy. Through 

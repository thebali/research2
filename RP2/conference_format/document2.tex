...
User-topics explains the user behaviour for valuing the aspects which are denoted by each latent topic. The item is modeled as a distribution of topics which together 

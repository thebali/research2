...
The work in [15], the authors have described the Hidden Factors and Topics model(HFT), which comprises of the LDA (Latent Dirchlet Allocation) model for the items using the review text and a matrix factorization
